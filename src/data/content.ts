...
const fr = {
  ...
  ui: {
    ...
    messagePlaceholder: 'Décrivez-nous votre projet, véhicule recherché, budget, délais…',
    formRequiredNote: 'Les champs suivis d’un * sont obligatoires.',
...
const en: typeof fr = {
  ...
  ui: {
    ...
    messagePlaceholder: 'Tell us about your project, the car you are looking for, budget, timing…',
